...
scaled.train.knn = computeMissingValues(scaled.train, type = "remove")
...
predictAndSave(scaled.train.remove.low.cor,scaled.test,'subs-svm/12.csv')
```
...
predictAndSave(scaled.train.knn, scaled.test,'missing-knn-sin-outliers-raros-outliers-knn.csv',kernel="radial")
```
...
- PCA y todo igual 
- Combinación juanlu -> subo a pos 3 0.92649
- Cambio orden juanlu -> subo a 2 0.92751